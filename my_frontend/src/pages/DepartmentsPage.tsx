      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            style={{ background: "linear-gradient(135deg, var(--primary), #a78bfa)", border: "none" }}
          >
      ...
      >
        ...
        {departments.length === 0 ? (
          <div className="flex flex-col items-center gap-2 py-16">
            <Building2 style={{ width: "40px", height: "40px", color: "var(--border)" }} />
            <p className="text-sm" style={{ color: "var(--muted-foreground)" }}>No departments found.</p>
          </div>
        ) : (
          <div className="divide-y" style={{ borderColor: "var(--border)" }}>
            {departments.map((department) => (
              <div
                key={department.id}
                className="flex items-center justify-between px-6 py-4 transition-colors hover:bg-[var(--muted)]"
              >
                <div className="flex items-center gap-3">
                  <div
                ...
                >
                  <Trash2 style={{ width: "15px", height: "15px", color: "var(--destructive)" }} />
                </button>
              </div>
            ))}
          </div>
